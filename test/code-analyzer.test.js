...
describe('The javascript parser', () => {
    ...
    it('while block', () => {
        assert.equal(
            getAllParsedCode(parseCode('while(x>2){\n' +
                '  x=x+2;\n' +
                '}')),
            '<table border="2"><tr><td>Line</td><td>Type</td><td>Name</td><td>Condition</td><td>Value</td></tr><tr><td>1</td><td>WhileStatement</td><td> </td><td>x>2</td><td> </td></tr><tr><td>2</td><td>AssignmentExpression</td><td>x</td><td> </td><td>x+2</td></tr></table>'
        );
    });
